class axi_m_r_agent extends uvm_agent;
    ...
    `uvm_component_utils(axi_m_r_agent)
           ...
           axi_m_r_monitor monh;
           axi_m_r_driver drvh;
           axi_m_r_seqr seqrh;

           function new(string name ="axi_m_r_agent",uvm_component parent);
           ...
           //         `uvm_fatal("SLAVE_AXI_WRRESP_AGENT","interface not getting in wresp agent")
             ...
             monh= axi_m_r_monitor::type_id::create("monh",this);
             
            // if(cfg.is_active==UVM_ACTIVE)
            //   begin
                 
                 drvh= axi_m_r_driver::type_id::create("drvh",this);
                 seqrh=axi_m_r_seqr::type_id::create("seqrh",this);
            //   end
